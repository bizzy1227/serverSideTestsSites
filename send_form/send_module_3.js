...
const checkSend  = async function(URL, getWebErr, cp, myProxy, withLogsWeb, withLogsForm, email) {
    ...
    /*
        1. Тест видео
            1.1 Проверить как будет работать метод с видео на телефонах
            1.2 Работа с видео без пульсирующего значки (i)
        2. рашить проблему с возвратом результата бота телеграм при лимите в 4000 символов
        3. добавить старые девайсы
        4. Удалить лишние коментарии
        5. Добавить lint
